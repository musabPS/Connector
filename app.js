...
//     name: "im a copy",
//     parents: ["1_DSSimZs7OD__958lJgd6Kpl65B3nNOP"]
//   };
  
//   drive.files.copy(
//     {  // Modified
//       fileId: "1NcA5fMjFnIOj_-XAUwoD6XE4Tkj8c-WI6Ls1kLxlk9k",
...
function listFiles(auth) {
  ...
  drive.files.copy({
    ...
    if (err) return console.log('The API returned an error: ' + err);
      ...
      opn('https://docs.google.com/spreadsheets/d/'+res.data.id, {app: 'firefox'});
    }
  });
